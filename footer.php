            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="widget span3">
                        ...
                        <p><i class="icon-user"></i> Skype: Suarota_Agency</p>
                        <p><i class="icon-envelope-alt"></i> Email: <a href="">contact@Suarota.co.uk</a></p>
                    </div>
                </div>
                <div class="footer-border"></div>
                <div class="row">
                    <div class="copyright span4">
                        <p>Copyright <?php echo date('Y'); ?> Suarota - All rights reserved. Template by <a href="http://azmind.com">Azmind</a>.</p>
                    </div>
